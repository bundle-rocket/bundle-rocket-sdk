 ...
 * that was downloaded as part of a BundleRocket update. The value returned
...
@interface BundleRocketConfig : NSObject
...
@interface BundleRocketDownloadHandler : NSObject <NSURLConnectionDelegate>
...
@interface BundleRocketPackage : NSObject
...
typedef NS_ENUM(NSInteger, BundleRocketInstallMode) {
    BundleRocketInstallModeImmediate,
    BundleRocketInstallModeOnNextRestart,
    BundleRocketInstallModeOnNextResume
};